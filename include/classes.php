	...
	function filter_sites_table_settings($arr_settings)
	{
		$arr_settings['settings_analytics'] = array(
			'setting_analytics_albacross' => array(
				...
				'global' => false,
				'icon' => "fas fa-dove",
				'name' => __("Analytics", 'lang_analytics')." - "."Albacross",
			),
			...
			'setting_analytics_facebook' => array(
				...
				'name' => __("Analytics", 'lang_analytics')." - "."Facebook Pixel",
			),
			'setting_analytics_fullstory' => array(
				'type' => 'string',
				'global' => false,
				'icon' => "fas fa-book",
				'name' => __("Analytics", 'lang_analytics')." - "."FullStory",
			),
			'setting_analytics_google' => array(
				'type' => 'string',
				'global' => false,
				'icon' => "fab fa-google",
				'name' => __("Analytics", 'lang_analytics')." - "."Google Analytics",
			),
			'setting_analytics_tag_manager' => array(
				'type' => 'string',
				'global' => false,
				'icon' => "fab fa-google",
				'name' => __("Analytics", 'lang_analytics')." - "."Google Tag Manager",
			),
			'setting_google_search_console' => array(
				'type' => 'string',
				'global' => false,
				'icon' => "fab fa-google",
				'name' => __("Analytics", 'lang_analytics')." - "."Google Search Console",
			),
		);
